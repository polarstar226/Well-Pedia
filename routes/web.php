...
Route::get('/admin/client_register', 	    'ClientController@toAdminClientRegister')               ->name('toAdminClientRegister');
Route::get('/admin/client_view', 		    'ClientController@toAdminClientView')			        ->name('toAdminClientView');
Route::get('/admin/client_edit', 		    'ClientController@toAdminClientEdit')		            ->name('toAdminClientEdit');
Route::get('/admin/client_reset', 		    'ClientController@toAdminClientReset')		            ->name('toAdminClientReset');
...
Route::get('/admin/video_register',		    'VideoController@toRegister')                           ->name('toAdminVideoRegister');
Route::get('/admin/video_edit',			    'VideoController@toEdit')                               ->name('toAdminVideoEdit');
...
Route::get('/admin/staff_edit', 		    'StaffController@toEdit')			                    ->name('toAdminStaffEdit');
Route::get('/admin/staff_view', 		    'StaffController@toView')			                    ->name('toStaffView');
Route::get('/admin/staff_register', 	    'StaffController@toAdd')                                ->name('toAdminStaffRegister');
...
Route::get('/admin/news_register',          'NewsController@toAdminNewsRegister')                   ->name('toAdminNewsRegister');
Route::get('/admin/news_detail',            'NewsController@toAdminNewsDetail')                     ->name('toAdminNewsDetail');
Route::get('/admin/news_edit',              'NewsController@toAdminNewsEdit')                       ->name('toAdminNewsEdit');
