                ...
                <div class="container-fluid px-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 navbar_list align-items-center">
                            <li class="nav-item">
                                <a class="nav-link text-center" href="#">TOP</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center" href="#">Company</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center" href="#">News</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center" href="#">Contact</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center btn_nav_item mx-auto" href="#">MEMBER</a>
                            </li>
                        </ul>
                        <!-- Left links -->
                    </div>
