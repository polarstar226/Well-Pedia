                                ...
                                <div class="video_card_content">
                                    <div class="card_title">
                                        <div class="video_control">
                                            <video autoplay loop id="bgvid" width="100%" height="100%">
                                                <source src="{{ $relax->video_url }}" type="video/mp4">
                                            </video>
                                            <!-- play button -->
                                            <button class="play_btn" onclick="onPlayVideo({{ $relax->id }})">
                                    ...
                                    <div class="card_body">
                                        <h4 class="font-weight-bold">
                                            <a href="{{ route('toPlayVideo') . '?id=' . $relax->id }}" class="text_48 video_name">
                                                {{ $relax->video_title }}
                                            </a>
                                        </h4>
