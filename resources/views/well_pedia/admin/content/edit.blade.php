...
@section('content')
                        ...
                        <table class="table form_table_td_sizer td_sizer_5 w_100 form_table ">
                            <tbody>
                                        ...
                                        <div class="csv_content_wrapper">
                                            <div class="csv_upload_wrapper d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="uploader">
                                                    ...
                                                    <input type="hidden" name="concept_image" value="{{ $result->concept_image }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <textarea class="form-control textarea_height" name="concept_text" id="concept_text"></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <div class="csv_content_wrapper">
                                            <div class="csv_upload_wrapper d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="uploader">
                                                    ...
                                                    <input type="hidden" name="recommendation_image" value="{{ $result->recommendation_image }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <textarea class="form-control textarea_height" name="recommendation_text" id="recommendation_text"></textarea>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#concept_text').html("{{ $result->concept_text }}");
            $('#recommendation_text').html("{{ $result->recommendation_text }}");
            $('.concept_upload').html("{{ $result->concept_filename }}");
            $('.recommendation_upload').html("{{ $result->recommendation_filename}}");
        });
