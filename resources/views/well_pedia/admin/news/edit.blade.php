                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <textarea class="form-control textarea_height" id="news_caption" name="news_caption" style="{{ $errors->has('news_caption') ? 'border : 1px solid #D9214E!important;' : '' }}">{{ $news->news_caption }}</textarea>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
