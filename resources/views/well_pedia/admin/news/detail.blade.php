...
@section('content')
        ...
        <section>
            <div class="section_container container_left_helper container_right_helper">
                <div class="section_title section_title_mb title_padding title_border_bottom d-flex justify-content-between">
                    ...
                    <div class="form_control_action text-center mt-40">
                        <button class="btn_dark  shadow-0 border-0" onclick="toAdminNewsEdit({{ $news->id }})">
                            更新する
                        </button>
                    </div>
                </div>
                            ...
                            <div class="col_wrapper card_wrapper">
                                ...
                                <div class="card_footer">
                                    ...
                                    <h5 class="text-center extra_foot">
                                        <a href="{{ route('toAdminNews') }}" class="text_48">
                                            <i class="fas fa-angle-left"></i>
    ...
    <script>
        function toAdminNewsEdit(id){
            window.location.href = "{{ route('toAdminNewsEdit') }}?id=" + id;
        }
    </script>
@endsection('content')
