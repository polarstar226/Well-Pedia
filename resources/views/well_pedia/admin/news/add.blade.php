    ...
    <main>
        <section>
            <div class="section_container container_left_helper container_right_helper">
                ...
                <form action="{{ route('onAdminNewsRegister') }}" method="post" class="" id="form_data">
                    @csrf
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control h_40" name="news_title" value="{{ old('news_title') }}" style="{{ $errors->has('news_title') ? 'border : 1px solid #D9214E!important;' : '' }}">
                                        </div>
                                        ...
                                        <div class="csv_content_wrapper">
                                            <div class="csv_upload_wrapper d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="uploader">
                                                    ...
                                                    <input type="hidden" name="news_url" id="news_url" value="{{ old('news_url') }}">
                                                    <input type="hidden" name="filename" id="filename" value="{{ old('filename') }}">
                                                </div>
                                                <h5 class="csv_uploader_output"></h5>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <textarea class="form-control textarea_height" name="news_caption" style="{{ $errors->has('news_caption') ? 'border : 1px solid #D9214E!important;' : '' }}">{!! old('news_caption') !!}</textarea>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="form_control_action text-center">
                        <button class="btn_dark btn_orange btn_mt_4  content_mb border-0" type="submit">
                            登録する
                        </button>
                    </div>
                </form>
