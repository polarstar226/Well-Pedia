                        ...
                        <table class="table form_table">
                            <tbody>
                                {{-- <tr>
                                    ...
                                    <td>
                                        <div class="form-group w_200">
                                            <input type="text" class="form-control" name="company_name" value="{{ $staff->company_name }}" style="{{ $errors->has('company_name') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="company_name">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group w_200">
                                            <input type="text" class="form-control" name="company_code" value="{{ $staff->company_code }}" style="{{ $errors->has('company_code') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="company_code">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group w_200">
                                            <input type="text" class="form-control" name="staff_number" value="{{ $staff->staff_number }}"  style="{{ $errors->has('staff_number') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="staff_number">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group w_200">
                                            <input type="text" class="form-control" name="deploy" value="{{ $staff->deploy }}" style="{{ $errors->has('deploy') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="deploy">
                                        </div>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-6">
                                                <div class="form-group w-100">
                                                    <input type="text" class="form-control" name="first_name" value="{{ $staff->first_name }}" style="{{ $errors->has('first_name') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="first_name">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group w-100">
                                                    <input type="text" class="form-control" name="last_name" value="{{ $staff->last_name }}" style="{{ $errors->has('last_name') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="last_name">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group w_200">
                                            <input type="text" class="form-control" name="email" value="{{ $staff->email }}" style="{{ $errors->has('email') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="email">
                                        </div>
                                        @if($errors->has('email'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group w_200">
                                            <input type="text" class="form-control" name="password" value="{{ $staff->password }}" style="{{ $errors->has('password') ? 'border : 1px solid #D9214E!important; color:#D9214E!important' : '' }}" id="password">
                                        </div>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" value="00" class="table_input_control"> cm
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" value="00" class="table_input_control"> Kg
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" value="00" class="table_input_control"> kg/m2
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" value="2.0" class="table_input_control">
                                        </td>
